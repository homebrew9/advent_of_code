...
seed_from = seed_list[(seed_nbr - 1) * 2]
seed_size = seed_list[(seed_nbr - 1) * 2 + 1]
#print(f'seed_from, seed_size, seed_range = {seed_from}, {seed_size}, [{seed_from}, {seed_from+seed_size+1})')

min_val = float('inf')

for seed in range(seed_from, seed_from + seed_size):
    #print(f'seed = {seed}')
    soil = None
...
out_file = f'result_{seed_nbr}.log'
fh = open(out_file, 'w')

#print(f'Start Date   = {start_date}')
#print(f'End Date     = {end_date}')
#print(f'Elapsed Time = {elapsed_ts}')
#print(f'Min Val      = {min_val}')

fh.write(f'Start Date   = {start_date}\n')
fh.write(f'End Date     = {end_date}\n')
fh.write(f'Elapsed Time = {elapsed_ts}\n')
fh.write(f'Min Val      = {min_val}\n')
fh.close()
